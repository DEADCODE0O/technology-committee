...
export function FacebookButton({
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className="flex h-12 w-full items-center justify-center gap-3 rounded-xl border border-[#1877F2]/30 bg-[#1877F2]/10 text-sm font-extrabold text-[#1877F2] transition-all hover:border-[#1877F2]/50 hover:bg-[#1877F2]/20 active:scale-[0.99] dark:text-zinc-100"
    >
