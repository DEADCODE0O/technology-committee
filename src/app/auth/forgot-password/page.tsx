      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="rounded-3xl border border-white/[0.08] bg-surface/90 p-6 shadow-[0_30px_80px_-30px_rgba(0,0,0,0.9)] backdrop-blur-xl sm:p-8">
          <div className="mb-6 text-center">
            ...
            <h1 className="text-2xl font-extrabold text-zinc-50">استعادة كلمة السر</h1>
            <p className="mt-1.5 text-sm leading-6 text-zinc-500">
              اكتب بريدك وسنرسل لك رابطًا آمنًا لتعيين كلمة سر جديدة
            </p>
          </div>
          ...
          <p className="mt-6 text-center text-sm text-zinc-500">
            <Link
              href="/login"
              className="font-bold text-gold-light transition-colors hover:text-gold"
            >
